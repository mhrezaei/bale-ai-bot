...
echo "================================================="
echo "🚀 Starting Hedioum Production Deployment..."
echo "================================================="
...
echo "[2/3] 🏗️ Rebuilding and starting Next.js Panel and Telegram Bot..."
docker compose --env-file .env.production -f docker-compose.prod.yml up -d --build maskhare_panel maskhare_bot
